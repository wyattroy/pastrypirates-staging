...
HTML
cd "$(dirname "$0")/../.." || exit 1
echo "var-in-keyframes page:"; xvfb-run -a node scripts/wk_probe.mjs "file://$SCR/var.html" "#a" 1400
echo "literal page:";          xvfb-run -a node scripts/wk_probe.mjs "file://$SCR/lit.html" "#a" 1400
