 ...
 *
 * Usage:  xvfb-run -a node scripts/wk_probe.mjs <url> <cssSelector> [sampleMs=1400]
 * Prints: JSON { engine, min, max, swing } of the selector's painted width across the window.
 *
 * RED-PROOF (run before trusting): scripts/wk_redproof.sh drives the known-bad 24d pattern
