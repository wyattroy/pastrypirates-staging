...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  .rulesPage { position: relative; z-index: 1;
    ...
    max-width: 720px; margin: 40px auto; padding: 30px 28px 40px; }
  @media (max-width: 600px) {
    ...
    .rulesPage { margin: 16px 12px; padding: 22px 18px 30px; border-radius: 16px; border-width: 2px; } }
