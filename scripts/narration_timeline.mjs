 ...
 *
 *   node scripts/narration_timeline.mjs <outdir> <W> <H> <port> <dbgport> [--crew <port2> <dbg2> <dbg3>] [--json <file>]
 *
 * e.g.  node scripts/narration_timeline.mjs /tmp/e-before 1400 900 8611 9611 \
