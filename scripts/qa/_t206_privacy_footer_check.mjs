/* _t206_privacy_footer_check.mjs — the RED check for qid:t206-privacy-line, written BEFORE any fix.
 *
 ...
 *
 * ⛔ DELIBERATELY NOT IN `npm test` until the fix lands — a gate added red is a gate somebody
 * disables (same convention as every other _t206 scratch check).
 *
 *   node scripts/qa/_t206_privacy_footer_check.mjs     exit 1 = still broken (today)
 *                                                       exit 0 = his ruling is implemented
 */
