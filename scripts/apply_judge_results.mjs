...
//
// Usage: node scripts/apply_judge_results.mjs <gate-output-dir>
import fs from "node:fs";
import path from "node:path";

const dir = process.argv[2];
if (!dir) { console.error("usage: node scripts/apply_judge_results.mjs <gate-output-dir>"); process.exit(2); }
