...
//
// Usage:
//   node 4/scripts/pulse_menu_probe.mjs                 # Chrome (baseline)
//   PW_DIR=/tmp/pw node 4/scripts/pulse_menu_probe.mjs --webkit   # the Safari-family engine
//   ... --menus=16 --phone
...
const OUT    = path.join(REPO, "4", "scripts", ".pulse-probe");
