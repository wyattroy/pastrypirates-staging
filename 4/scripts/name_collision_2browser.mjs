 ...
 *
 *   node 4/scripts/name_collision_2browser.mjs [--port=N] [--dbgA=N] [--dbgB=N] [--out=DIR]
 *
 * WHY IT EXISTS. 4/scripts/name_claim_check.js proves the RULE — pure, 43 assertions, red-proofed.
