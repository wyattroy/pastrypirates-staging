...
- a captain's crates overlapping each other in the captains panel is DESIGNED (Wyatt, 2026-09-11): every hold stays on one line, spaced by the same few pixels as the row's top and bottom padding (Wyatt, 2026-09-13), and when they do not fit they slide together — up to 35% overlap, each with a soft edge — and past that the line scrolls sideways with a fade at its right edge. A fade or a half-covered crate there is never a clipping fault;
- the coloured ring around one captain's row is whose turn it is, and it is drawn OUTSIDE the row (Wyatt, 2026-09-12). A ring that appears to sit on top of the row above or below it is that rule, not a layout fault;
