...
export const WORDS = {
  ...
  /* THE VICTORY CARD (src/ui/victory.js, docs/VICTORY-CARD-PRD.md) — his wording from the Victory Card sheet where he gave it */
  "victory.winsVoyage": "{w:wins the voyage!|ye win the voyage!}",
  "victory.nobody": "Nobody finished the voyage",
  ...
  "victory.chip.score": "Score",
  "victory.close.ovens.one": "{w} {w:was|were} ONE ingredient from the ovens!",
  "victory.close.ovens.many": "{w} {w:was|were} {n} ingredients from the ovens!",
  "victory.close.bake.one": "{w} {w:was|were} ONE crate from the win!",
  "victory.close.bake.many": "{w} {w:was|were} {n} crates from the win!",
  "victory.number.2": "TWO",
  "victory.number.3": "THREE",
  "victory.number.4": "FOUR",
  "victory.number.5": "FIVE",
  "victory.close.howBake": "At the ovens, {n} of {size} crates named",
  "victory.close.howSail": "{n} of {size} crates, {sq} squares from Tortuga",
  "victory.close.place": "{place} of {total} captains",
  "victory.place.1": "1st",
  "victory.place.2": "2nd",
  "victory.place.3": "3rd",
  "victory.place.4": "4th",
  "victory.close.nextBake": "Name the rest right, and the bake is won",
  ...
  "victory.score.title": "{w's} voyage score",
  "victory.score.total": "Voyage score",
  "victory.score.best": "NEW BEST VOYAGE!",
  "victory.row.crates": "Recipe crates in the hold",
  "victory.row.ovens": "Ovens lit at Tortuga",
  "victory.row.named": "Bake-off crates named right",
  "victory.row.perfect": "Perfect bake-off",
  "victory.row.won": "Won the voyage",
  "victory.row.ahead": "Days ahead of the navigator",
  "victory.row.coins": "Doubloons in the hold",
  "victory.row.trades": "Traded like a Good Friendly Pirate",
  "victory.row.day": "day {n}",
  "victory.row.firstTry": "first try",
  "victory.row.twoTries": "two tries · half",
  "victory.dock.label": "Anchors up, play again!",
  "victory.dock.setting": "Setting sail…",
  "stats.days": "Days",
